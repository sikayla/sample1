...
<head>
    ...
    @media (min-width: 768px) {
        .modal-content {
            /* No change needed here, max-width and max-height are already set for larger screens */
        }
    }
        ...
        <div class="flex flex-col md:flex-row items-center md:items-center gap-12 md:gap-24">
            ...
            <div class="flex-shrink-0 w-full max-w-md md:max-w-none md:w-[480px] fade-in">
                <img
                    ...
                    class="w-full h-auto object-contain rounded-lg shadow-md transition transform hover:scale-105 duration-300" src="/ventech_locator/images/gif.gif"
                />
            </div>
     ...
     <main class="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div class="flex flex-col md:flex-row w-full min-h-[300px]">
           ...
           <div class="md:w-1/2 w-full bg-[#263238] p-8 flex flex-col justify-center">
            ...
            <ul class="space-y-3 text-white text-sm font-light max-w-md">
             <li class="flex items-start">
              <i class="fas fa-check-square mt-[3px]">
              </i>
              <span>
